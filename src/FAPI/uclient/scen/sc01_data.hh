...
static l1_tlv_word_t CONFIG_REQUEST_TLVS [] = {
    /* Duplexing Mode                 1 */
    ...
    {FAPI_L1_SFN_SF                                     , 2, {728 << 4}}
};
static size_t CONFIG_REQUEST_TLVS_num = sizeof(CONFIG_REQUEST_TLVS) / sizeof(l1_tlv_word_t);
...
struct fapi_l1_ul_config_request ul_bch_config = {
  ...
  // struct fapi_l1_dl_pdu_tlv dl_bch_pdu_tlv [] = 
